...
//
        ...
        ListNode listNode = solution.addTwoNumbers(listNode2Final, listNodeSecond5Final);
    }
}
...
/*        ListNode listNode3 = new ListNode(3);
        ...
        ListNode listNode2Final = new ListNode(2, listNode4);
...
/* public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        Long result = nodeToArray(l1, 1l) + nodeToArray(l2, 1l);
        return arrayToNode(new ListNode((int)(result % 10)), result / 10);
    }

    public Long nodeToArray(ListNode l1, Long ten) {
        if (l1.next == null) {
            return l1.val * ten;
        } else {
            return l1.val * ten + nodeToArray(l1.next, ten * 10);
        }
    }

    public ListNode arrayToNode(ListNode l, Long number) {
        if (number == 0) {
            return l;
        }
        ListNode listNode = new ListNode((int)(number % 10));
        l.next = listNode;
        arrayToNode(listNode, number / 10);
        return l;
    }
*/